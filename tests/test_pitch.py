...
class PitchModelTest(unittest.TestCase):
    def setUp(self):
        self.user_Joe = User(username = 'Joe',password = 'magic', email = 'joe@test.com')
        self.new_pitch = Pitch(id=1,pitch_title='Test',pitch_content='This is a test pitch',category="interview",user= self.user_Joe,likes=0,dislikes=0)
